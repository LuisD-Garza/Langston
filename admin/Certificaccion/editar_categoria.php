...
if(isset($_POST['titulo']))
{
	...
	if(empty($imagen))
	{
		if($cantidadMixto > 0)
		{
			$mysqli->query("UPDATE certificaccion SET titulo = '$titulo', img = '$imagenauxiliar' WHERE id = '$id'");
			header("Location: " . $path . "Certificaccion/editar_categoria.php?id=$id&accion=e");
		} else {
			$mysqli->query("INSERT INTO certificaccion (titulo, img) VALUES ('$titulo', $imagenauxiliar')");
			header("Location: " . $path . "Certificaccion/editar_categoria.php?id=$id&accion=e");
		}
	} else {
		...
		if($cantidadMixto > 0)
		{
			$mysqli->query("UPDATE certificaccion SET titulo = '$titulo', img = '$imagen' WHERE id = '$id'");
			header("Location: " . $path . "Certificaccion/editar_categoria.php?id=$id&accion=e");
		} else {
			$mysqli->query("INSERT INTO certificaccion (titulo, img) VALUES ('$titulo', '$imagenauxiliar')");
			header("Location: " . $path . "Certificaccion/editar_categoria.php?id=$id&accion=e");		
