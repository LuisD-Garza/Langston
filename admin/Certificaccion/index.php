...
<div class="botones">
	<div onClick="window.location.href='<?php echo $path; ?>Certificaccion/textos.php?id=1'" class="boton hvr-sweep-to-right">Seccion 1</div>
	<div onClick="window.location.href='<?php echo $path; ?>Certificaccion/textos.php?id=15'" class="boton hvr-sweep-to-right">Seccion 2</div>
	<div onClick="window.location.href='<?php echo $path; ?>Certificaccion/textos.php?id=16'" class="boton hvr-sweep-to-right">Seccion 3</div>
	
	<div onClick="window.location.href='<?php echo $path; ?>Certificaccion/textos.php?id=18'" class="boton hvr-sweep-to-right">Seccion 4</div>
