...
<div class="texto">En esta apartado usted puede administrar los productos de su sitio web </div>
<div class="botones">
	<div onClick="window.location.href='<?php echo $path; ?>productos/productos.php'" class="boton hvr-sweep-to-right">Productos </div>
