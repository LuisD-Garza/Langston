...
<div class="botones">
	<div onClick="window.location.href='<?php echo $path; ?>Index/textos.php?id=1'" class="boton hvr-sweep-to-right">Seccion 1</div>
	<div onClick="window.location.href='<?php echo $path; ?>Index/textos.php?id=2'" class="boton hvr-sweep-to-right">Seccion 2</div>
	<div onClick="window.location.href='<?php echo $path; ?>Index/textos.php?id=3'" class="boton hvr-sweep-to-right">Seccion 3</div>
	<div onClick="window.location.href='<?php echo $path; ?>Index/mixto-s.php?id=4'" class="boton hvr-sweep-to-right">Seccion 4</div>
	<div onClick="window.location.href='<?php echo $path; ?>Index/list.php?id=5'" class="boton hvr-sweep-to-right">Seccion 5</div>
