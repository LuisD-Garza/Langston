...
$verificarMixto = $mysqli->query("SELECT * FROM `sectores` WHERE sectores.id = '$id'");
...
if(isset($_POST['titulo']) && isset($_POST['descripcion']))
{
	...
	if(empty($imagen))
	{
		if($cantidadMixto > 0)
		{
			$mysqli->query("UPDATE sectores SET titulo = '$titulo', descripcion = '$descripcion', descripcion2 = '$descripcion2', descripcion3 = '$descripcion3', img = '$imagenauxiliar' WHERE id = '$id'");
			header("Location: " . $path . "Certificaccion/textos.php?id=$id&accion=e");
		} else {
			$mysqli->query("INSERT INTO sectores (titulo, descripcion, descripcion2, descripcion3, img) VALUES ('$titulo', '$descripcion', '$descripcion2', '$descripcion3' '$imagenauxiliar')");
			header("Location: " . $path . "Certificaccion/textos.php?id=$id&accion=e");
		}
	} else {
		...
		if($cantidadMixto > 0)
		{
			$mysqli->query("UPDATE sectores SET titulo = '$titulo', descripcion = '$descripcion', descripcion2 = '$descripcion2', descripcion3 = '$descripcion3', img = '$imagen' WHERE id = '$id'");
			header("Location: " . $path . "Certificaccion/textos.php?id=$id&accion=e");
		} else {
			$mysqli->query("INSERT INTO sectores (titulo, descripcion, descripcion2, descripcion3, img) VALUES ('$titulo', '$descripcion', '$descripcion2', '$descripcion3' '$imagenauxiliar')");
			header("Location: " . $path . "Certificaccion/textos.php?id=$id&accion=e");		
...
<div class="linea"></div>
<div class="accion">
	<div onClick="window.location.href='<?php echo $path.'Sectores/index.php'; ?>'" class="boton hvr-sweep-to-right">Regresar</div>
</div>
<div class="objetos">
	<?php
	$obtenerCategorias = $mysqli->query("SELECT * FROM `sectores` WHERE sectores.categoria = '$id'");
